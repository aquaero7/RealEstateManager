...
val uris = listOf(uriProperties, uriAddresses, uriPhotos, uriAgents, uriTypes, uriPois, uriPropertyPoiJoins)
...
fun initTest(contentResolver: ContentResolver, uri: Uri): Pair<Cursor?, Triple<String?, String?, String?>> {
...
suspend fun cursorAndQuery(contentResolver: ContentResolver, uri: Uri, projection: Array<String>?): Cursor? =
